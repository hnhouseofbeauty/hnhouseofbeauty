    ...
    <div className="pt-16 w-full">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 text-center animate-fade-in-up">
            <div className="animate-stagger-1">
              <div className="flex justify-center mb-2">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-6 h-6 text-gold fill-current transform hover:scale-110 transition-transform duration-300" />
                ))}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className={`service-card animate-scale-in animate-stagger-${index + 1} text-center hover:shadow-2xl transition-all duration-500`}>
          ...
          <div className="animate-scale-in">
            <div className="testimonial-card max-w-2xl mx-auto text-center transform hover:scale-105 transition-all duration-500">
              <div className="flex justify-center mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 text-gold fill-current transform hover:scale-110 transition-transform duration-300" />
                ))}
              </div>
      ...
      <section className="py-16 bg-gold w-full">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in-up">
          ...
          <Button 
            asChild 
            className="bg-white text-gold hover:bg-white/90 px-8 py-6 text-lg rounded-full font-semibold transform hover:scale-105 transition-all duration-300"
          >
            <a 
